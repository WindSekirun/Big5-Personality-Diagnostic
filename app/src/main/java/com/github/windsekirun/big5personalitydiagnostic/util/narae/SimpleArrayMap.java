...
/**
 * Base implementation of {@link NaraeMap} that doesn't include any standard Java
...
public class SimpleArrayMap<K, V> implements Serializable {
    private static final boolean DEBUG = false;
    private static final String TAG = "NaraeMap";

    /**
     * The minimum amount by which the capacity of a NaraeMap will increase.
    ...
    /**
     * Create a new empty NaraeMap.  The default capacity of an array map is 0, and
    ...
    /**
     * Create a new NaraeMap with a given initial capacity.
     */
    ...
    /**
     * Create a new NaraeMap with the mappings from the given NaraeMap.
     */
