...
/**
 * NaraeMap is a generic key->value mapping data structure that is
...
public class NaraeMap<K, V> extends SimpleArrayMap<K, V> implements Map<K, V>, Serializable {
     ...
     */
    public NaraeMap(SimpleArrayMap map) {
        super(map);
    }
